        ...
        >
            ...
            >
                <Text
                    ...
                    style={styles.WelcomeTitle}>Welcome to</Text>
                <Text
                    style={{
                        maxWidth: "64%",
                ...
                > Enter your email, choose a username and password</Text>
            </View>
            <InputField
                icon={<Icon
                    name="person"
            ...
            <CustomButton
                ...
                onPress={() => { Validate() ? handleRegister() : null }}
            />
            <View
                style={styles.MovetoLogin}
            >
            ...
            <CustomButton
                ...
                Icon={<Image source={require("../../assests/images/facebook.png")}
                    style={{
                        height: 20,
                        width: 20,
            ...
            <CustomButton
                ...
                label={"Login With Facebook"}
                Icon={<Image source={require("../../assests/images/google.png")}
                    style={{
                        height: 20,
                        width: 20,
